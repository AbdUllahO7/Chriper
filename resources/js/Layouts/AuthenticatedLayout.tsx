            ...
            <nav className="glass-nav sticky top-0 z-50 border-b border-white/10 shadow-2xl backdrop-blur-xl">
                            ...
                            <div className="relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('kpi-dashboard.index')} className="flex items-center gap-2">
                                            <span>🎯 Practice KPI Dashboard</span>
                                        </Dropdown.Link>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' lg:hidden border-t border-white/10 bg-[#0b0f19]/95 backdrop-blur-xl'}>
                    <div className="space-y-1 p-4">
                        ...
                        <ResponsiveNavLink href={route('kpi-dashboard.index')} active={route().current('kpi-dashboard.*')}>
